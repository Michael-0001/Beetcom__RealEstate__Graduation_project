...
?>
  ...
  <div class="hero-wrap" style="background-image: url(../beetcom/layout/img/2272186909_de0f7e5da1_o.jpg);" data-stellar-background-ratio="
  0.5">
...
<div class="container">
        <aside class="parent-ad col-md-2 col-sm-12 pop" >
        <p class="ad">
          <?php include("includes/functions/manage_side_ads.php"); ?>
          <a href="side_ads_form.php" class="join">Join Us and Creat a Side Ads...</a>
        </p>
        </aside>

      <div id="ajaxData" class="col-md-10 col-sm-12">        </div>
