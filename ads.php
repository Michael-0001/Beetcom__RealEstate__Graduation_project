<?php
$page_title = 'BeetCom(ADS)';

include("includes/template/myaccount_header.php");


$user = new users();
$data = $user->findby('id' , $_SESSION['id']);
...
if($data['accountType'] > 0){
  if($data['accountType'] == 1){
      ...
      echo "<h2>Valid Untill :" . $data['paid_acc_end_date'] . "</h2>";
  }
          ...
          <div class="col-lg-12">
              <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6" >
                    <div class="box time" style="height: 946px;">
                        <div class="img-holder"><img src="../beetcom/layout/img/slid1.jpg" alt="" /></div>
                        <h2>Gold</h2>
                        <br><br>
                        <div class="mb-3">
                                    <h4>Cost: 500 EGP</h4>
                        ...
                        <div class="mb-3">
                                    <h4>Quantity of Ads : Unlimited</h4>
                        </div>
                        
                        <div class="mb-3">
                                    <h4>Order: Top 20 Properties</h4>
                        </div>
                        <form method="post" action="includes/functions/prop_ads.php">

                        <div class="form-group mt-3">
                        <p class="danger">Note that : Your Credit in our Page must cover the the Package Cost</p>
                                    Are You Sure that You want such Package and it fits your needs? 
                                    <input type="checkbox" required>
                                    <input type="hidden" name="pkg_type" value="1">
                        </div>
                  ...
                  <div class="col-lg-6 col-md-6">
                    <div class="box passion" style="height: 946px;">
                        <div class="img-holder"><img src="../beetcom/layout/img/slid3.jpg" alt="" /></div>
                        <h2>Platinum</h2>
                        <br><br>
                        <div class="mb-3">
                                    <h4>Cost: 1000 EGP</h4>
                        ...
                        <p class="danger">Note that : Your Credit in our Page must cover the the Package Cost</p>
                                    Are You Sure that You want such Package and it fits your needs? 
                                    <input type="checkbox" required>
                                    <input type="hidden" name="pkg_type" value="2">
                        </div>
                          <button type="submit" class="btn btn-primary">Send message</button>
