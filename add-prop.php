                   ...
                   <div class="d-flex justify-content-center">
                     <div class="col-lg-4">
                      <form action="includes/functions/insert_prop.php"method="post" enctype="multipart/form-data">
                        ...
                        <select id="defaultSelect" class="form-select" name="prop_type" required>
                          ...
                          <div class="mb-3">
                            ...
                            <textarea class="form-control" id="message-text"placeholder="Property Title" name="title" required></textarea>
                          </div>
                          
                          <div class="form-group mt-3 d-flex justify-content-center">
                        <select id="defaultSelect" class="form-select" name="delivery_type" required>
                          ...
                          <div class="form-group mt-3">
                            <input type="number" id="bed" class="form-control" placeholder="Bedrooms Number" name="bedroom"required>
                          </div>
                          <div class="form-group mt-3">
                            <input type="number" id="path" class="form-control" placeholder="Bathrooms Number" name="bathroom"required>
                          </div>
                          <div class="form-group mt-3">
                            <input type="number" id="living" class="form-control" placeholder="Livingrooms Number" name="livingroom"required>
                          </div>
                          <div class="form-group mt-3">
                            <input type="number" id="kitchen" class="form-control" placeholder="Kitchens Number" name="kitchen"required>
                          </div>
                          <div class="form-group mt-3">
                            <input type="number" id="area" class="form-control" placeholder="Area(meter sequer)" name="area"required>
                          </div>
                          <div class="form-group mt-3">
                            <input type="text" id="price" class="form-control" placeholder="Average Price" name="price"required>
                          </div>
                          <div class="mb-3">
