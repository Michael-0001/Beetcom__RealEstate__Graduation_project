...
for( $i=0; $i < count($data) ; $i++ ){
    if($row ==0){
        $prop_id = $data[$i]['id'];
        $img = $images->findby('property_id',$prop_id);
        if(empty($img['property_image'])){
            $img_name = 'default.jpg';
        }else{

        $img_name = $img['property_image'];
    ...
    <div class="container">
        ...
        <div class="col-lg-6">
                    <div class="property-wrap"><!-- Animation Issue -->
                        <div class="img d-flex align-items-center justify-content-center" style="background-image: url(data/images/properties/<?php echo $img_name ;?>);">
...
}else{                                          // there is no search  [[  Premium Properties  ]]
    $data = $prop->findAllby('isPaid',2);
    if(count($data) < 10 ){$limit = count($data);
    }else{
        $limit = 10;
    }
...
?>
    ...
    // ================================================================= Silver Properties =================================
    $data2 = $prop->findAllby('isPaid',1);
    if(count($data2) < 10 ){$limit = count($data2);
    }else{
        $limit = 10;
        // Choose random 10 from data2
    }
    ...
    <section class="ftco-section goto-here">
        <div class="container">
            ...
            <div class="col-lg-6">
                        <div class="property-wrap"><!-- Animation Issue -->
                            <div class="img d-flex align-items-center justify-content-center" style="background-image: url(data/images/properties/<?php echo $img_name; ?>);">
                                <a href="prop_details.php?id=<?php echo $data2[$i] ['id']?>" class="icon d-flex align-items-center justify-content-center btn-custom">
                                    <span class="ion-ios-link"></span>
                                </a>
                                ...
                                <div class="list-agent d-flex align-items-center">
                                    ...
                                    <div class="tooltip-wrap d-flex ">
                                        <a  class="<?php if(isset($_SESSION) && !empty($_SESSION)){if($interest->checkFav($data2[$i]['id'] , $_SESSION['id']) >0){echo "activate ";}else{echo "unactivate ";}}?> icon-2 d-flex align-items-center justify-content-center .property-favorite" id="<?php echo $data2[$i]['id']?>" data-toggle="tooltip" data-placement="top" title="Add to Favourite">
                                            <span class="ion-ios-heart"><i class="sr-only">Add to Favourite</i></span>
                                        </a>
                            ...
                            <div class="text">
                                <p class="price mb-3"><span class="orig-price">EGP <?php echo number_format( $data2[$i]['price'] );?></td><small></small></span></p>
                                <h3 class="mb-0"><a href="prop_details.php?id=<?php echo $data2[$i] ['id']?>"><?php echo $data2[$i]['prop_type']?></a></h3>
                                <span class="location d-inline-block mb-3"><i class="ion-ios-pin mr-2"></i><?php echo $data2[$i]['location']?></span>
                                <ul class="property_list">
                                    <li><span class="flaticon-bed"></span><?php echo $data2[$i]['bedrooms']?></li>
                                    <li><span class="flaticon-bathtub"></span><?php echo $data2[$i]['bathrooms']?></li>
                                    <li><span class="flaticon-floor-plan"></span><?php echo $data2[$i]['area']?> meter square</li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="img d-flex align-items-center justify-content-center" style="background-image: url(layout/header_nav_styling/images/work-9.jpg);">
                                ...
                                <div class="list-agent d-flex align-items-center">
                                    ...
                                    <div class="tooltip-wrap d-flex">
                                        <a  class="
                                        <?php
                                        if(isset($_SESSION) && !empty($_SESSION)){ if($interest->checkFav($data2[$i]['id'] , $_SESSION['id']) >0){echo "activate ";}else{echo "unactivate ";}
                                        }?> icon-2 d-flex align-items-center justify-content-center" id="<?php echo$data2[$i]['id']?>" data-toggle="tooltip" data-placement="top" title="Add to Favourite">
                                            <span class="ion-ios-heart"><i class="sr-only">Add to Favourite</i></span>
                                        </a>
