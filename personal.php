...
$page_title = 'BeetCom(Personal Information)';
...
<?php
$user = new users;
$data = $user->findbyid( $_SESSION['id'] ) ;
...
<form id="formAccountSettings" method="POST" action="includes/functions/update_users.php" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="John" aria-describedby="floatingInputHelp" name="newFname" value="<?php echo $data['Fname']?>"/>
                                    <label for="floatingInput">First Name</label>
                                    <div id="floatingInputHelp" class="form-text"></div>
                            </div>

                                  <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Mina" aria-describedby="floatingInputHelp" name="newSname" value="<?php echo $data['Sname']?>" />
                                  ...
                                  <div class="form-floating mb-3">
                                    <input type="text"class="form-control" id="floatingInput" placeholder="30 Harm St" aria-describedby="floatingInputHelp" name="newaddress" value="<?php echo $data['adress']?>"/>
                                    <label for="floatingInput">Address</label>
                                    <div id="floatingInputHelp" class="form-text"></div>
                                  </div>

                              <div class="form-floating mb-3">
                                <input type="tel" class="form-control" id="floatingInput" placeholder="(+02) 01288992202" aria-describedby="floatingInputHelp"  name="newphone" value="<?php echo $data['phone']?>"/>
                              ...
                              <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" placeholder="11016" aria-describedby="floatingInputHelp"  name="newzipCode"value="<?php echo $data['zip']?>"/>
                                <label for="floatingInput">ZIP Code</label>
                                <div id="floatingInputHelp" class="form-text"></div>
                              </div>

                              <div class="form-floating mb-3">
                                <input type="date" class="form-control" id="floatingInput" placeholder="18-10-2000" aria-describedby="floatingInputHelp" name="newdob" value="<?php echo $data['dob']?>"/>
