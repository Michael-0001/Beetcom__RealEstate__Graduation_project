                        ...
                        <div class="card mb-4">
                            <div class="row">
                                <div class="card-body col-lg-3">
                                    <a href="https://fawry.com/?lang=ar" target="_blank"><img src="layout/img/fawry.jpg" style="width: -webkit-fill-available;"></a>
                                </div>
                                <div class="card-body col-lg-3">
                                    <a href="https://web.vodafone.com.eg/en/vodafone-cash" target="_blank"><img src="layout/img/voda.jpg" style="width: -webkit-fill-available;"></a>
                                </div>
                                <div class="card-body col-lg-3">
                                    <a href="https://www.amanstores.com/" target="_blank"><img src="layout/img/download.png" style="width: -webkit-fill-available;"></a>
                                </div>
                            </div>
                            <div class="row justify-content-md-center justify-content-lg-center">
                              <div class="col-lg-auto">
                                <form method="post" action="includes/functions/payment.php" enctype="multipart/form-data">
                              <div class="mb-3">
                                <input
                                  class="form-control"
                                   type="text"
                                  id="exampleFormControlReadOnlyInput1"
                                 placeholder="Reference Number        90-021-321"
                                 readonly
                                   />
                              </div>
                              <div class="mb-3">
                        <input class="form-control" type="number" name="amount" placeholder="Amount Transfered">      
                        <br>
                        <label for="formFile" class="form-label">Upload The Bill Photo</label>
                        <input class="form-control" type="file" name="bill"  id="formFile" />
                            </div>
