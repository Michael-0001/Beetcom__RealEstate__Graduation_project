...
<!--========================================== Form Start =========================================-->
<!--===============================================================================================-->
<form id="formAccountSettings" method="POST" action="includes/functions/update_auth.php" enctype="multipart/form-data">
        <!-- Content wrapper -->
...
class="d-block rounded"height="100"width="100"id="uploadedAvatar"/>
                                <h1><?php echo $data['Fname'] . " " . $data['Sname'] ?></h1>
                                <h3>(<?php  if($data['userRole'] == 0 ){echo"User";}else{echo "Admin";}?>)</h3>
                            </div>
                            </div>
<!-- Image upload -->
                            ...
                            <div class="mb-3 col-md-6">
                                    ...
                                    <select  name="accountType" class="form-select">
                                        <option value="<?php echo $data['accountType']; ?>" selected><?php if($data['accountType'] == 0){  echo"User Account";}else{ echo"Business Account";}?></option>
                            ...
                            <div class="mb-3 col-md-6">
                                    ...
                                    <select  name="activated" class="form-select">
                                        <option selected value="<?php echo $data['activated'] ?>"> <?php if($data['activated'] == 0){  echo"Activated";}else{ echo"DeActivated";}?>  </option>
                            ...
                            <div class="mb-3 col-md-6">
                                    ...
                                    <select  name="role" class="form-select">
                                        <option selected value="<?php echo $data['userRole'] ?>"> <?php if($data['userRole'] == 0){  echo"Normal User";}else{ echo"Admin";}?>  </option>
