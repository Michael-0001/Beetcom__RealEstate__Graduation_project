...
<tbody>
    <?php
            ...
            <tr>    
                ...
                <td><?php echo $data[$i]['Fname'] . " " . $data[$i]['Sname'];?></td>
                <td><?php echo$data[$i]['email']?></td>
                <td><?php if($data[$i]['userRole'] == 0){  echo"User";}else{ echo"Admin";}?></td>
                <td><?php if($data[$i]['activated'] == 0 ){echo"<span class='text-success'>Activated</span>";}else{echo"<span class='text-danger'>DeActivated</span>";}?></td>
                <td>
                <a href="edit_auth.php?id=<?php echo$data[$i]['id'] ;?>"><button type="button" class="btn btn-primary">Edit</button></a>
                <br>
                <br>
