...
<tbody>
    <?php
            for($i =0; $i<count($payment_data);$i++){
              ...
              $user_id = $payment_data[$i]['user_id'];
                $user = new users();
                $user_data = $user->findby('id', $user_id);
            ?>
            <tr>    
                <th scope="row"><?php echo $payment_data[$i]['id']?></th>
                <td><?php echo $user_id?></td>
                <td><?php echo $user_data['Fname'] . " " . $user_data['Sname']?></td>
                <td><?php echo $payment_data[$i]['date'];?></td>
                <td><?php echo $payment_data[$i]['amount'] ;?></td>
                <td>
                <a href="payment_details.php?pay_id=<?php echo $payment_data[$i]['id'] ;?>"><button type="button" class="btn btn-primary">Payment Details</button></a>
