...
<thead class=" table-dark">
    <tr>
        ...
        <th scope="col">Requested Property Id </th>
        <th scope="col"></th>
    </tr>
</thead>
<tbody>
    <?php
            ...
            <tr>    
                ...
                <td><?php if($user_data['accountType'] == 0){  echo"Normal Account";}else{ echo"Paid Account ";}?></td>
                <td><?php echo $prop_id  ;?></td>
                <td>
                <a href="request_details.php?req_id=<?php echo $req_id ;?>"><button type="button" class="btn btn-primary">Open Request</button></a>
