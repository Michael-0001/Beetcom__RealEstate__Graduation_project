...
if(isset($_SESSION['email']) ) {
  ...
  $user_id = $_SESSION['id'];
  $ads = new side_ads();
  $ads_data = $ads->findby('user_id' , $user_id);
  $user = new users();
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                  <div class="col-md-12">
                      ...
                      <div class="col-lg-12">
                          <div class="card mb-4">
                              <h5 class="card-header text-center"> Side Ads Information</h5>
                              <div class="card-body">
                                  <div class="mb-3 row">
                                  ...
                                  <div class="mb-3 row">
                                  <label for="exampleFormControlReadOnlyInput1" class="col-md-2 col-form-label">Selected Package</label>
                                  <div class="col-md-10">

                                  <?php
                                  if( $ads_data['package'] == 1){   
                                      echo "Silver";
                                      $duration  = "1 Month";
                                      $cost = 2500;
                                  }elseif( $ads_data['package'] == 2){
                                      echo "Gold";
                                      $duration  = "6 Month";
                                      $cost = 13000;
                                  }else{
                                  ...
                                  ?>
                                      ...
                                      <ul>
                                          ...
                                          <li>Package Cost: <?php echo number_format($cost) . "$"; ?></li>
                                  ...
                                  <div class="mb-3 row">
                                  <label for="exampleFormControlReadOnlyInput1" class="col-md-2 col-form-label">Your Credit: </label>
                                  <div class="col-md-10">
                                  <?php echo number_format( $user_data['credit'] ). "$" ;?>
                                  ...
                                  <div class="col-md-10">
  <?php
                                  if( $ads_data['status'] == 0){echo "In Review";
                                  }elseif( $ads_data['status'] == 1){
                                      echo "Active";
                                  }elseif( $ads_data['status'] == 2){
                                          echo "Rejected";
                                      }elseif( $ads_data['status'] == 3){
                                          echo "Completed";}
                                      ?>
                                  </div>
                                  ...
                                  <div class="col-md-10">
                                      <img style="width: 300px;" src="data/images/side_ads/<?php echo $ads_data['ads_img'];?>">
                                      
                                  </div>
                              </div>
  <!--------------------------------------------- Start Edit Banner  -->

  <form id="formAccountSettings" method="POST" action="includes/functions/edit_side_ads_img.php" enctype="multipart/form-data">
                                  ...
                                  <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                      ...
                                      <input type="hidden" name="old_img" value="<?php echo $ads_data['ads_img']?>"/>
                                  </label>
                                        <br>
                                        <label>Confirm Uploading a new Image for side Ads</label>
                                        <input type="checkbox" value="0" required>
                                        <input type="submit" class="form-control" value="Submit" style="width: 300px;">
